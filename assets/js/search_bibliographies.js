$(document).ready(function() {
    ...
    function search() {
      ...
      for (var i = 0; i < yearHeaders.length; i++) {
        ...
        while (bibliography && bibliography.nodeName.toLowerCase() !== "ol" && !bibliography.classList.contains("bibliography")) {
        ...
        for (var j = 0; j < items.length; j++) {
          ...
          var periodical = item.querySelector(".periodical").textContent.toLowerCase();
